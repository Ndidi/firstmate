...
fm_test_case test_ff_updated
fm_test_case test_ff_current
fm_test_case test_ff_dirty
fm_test_case test_ff_diverged
fm_test_case test_ff_inflight_feature_branch
fm_test_case test_no_fetch_in_local_path
fm_test_case test_sweep_nudge_requires_instruction_change
fm_test_case test_bootstrap_sweep_nudges_only_instruction_change
fm_test_case test_bootstrap_nudge_send_uses_state_override
fm_test_case test_bootstrap_nudge_retry_rejects_malformed_marker_id
fm_test_case test_bootstrap_nudge_failure_records_retry_marker
fm_test_case test_bootstrap_nudge_retry_is_idempotent
fm_test_case test_bootstrap_nudge_retry_refuses_changed_home
fm_test_case test_nudge_retry_uses_fresh_herdr_endpoint_after_respawn
fm_test_case test_bootstrap_sweep_surfaces_skipped_home
fm_test_case test_spawn_fast_forwards_before_launch
fm_test_case test_spawn_warns_when_sync_skipped_before_launch
fm_test_case test_seed_marker_clean_when_gitignored
fm_test_case test_seed_marker_converges_existing_home
fm_test_case test_seed_marker_does_not_mask_real_dirt
