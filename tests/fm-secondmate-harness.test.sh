...
test_spawn_cursor_secondmate_launches_with_its_primary_contract() {
  ...
  launch=$(fm_launch_unwrap < "$launchlog")
...
# Run through fm_test_case (tests/require.sh): this file carries a recorded known
# failure at case 41 of 49, and without the wrapper it would end there and
# silently drop the last eight cases. The file still fails if any case fails.
fm_test_case test_harness_resolution
fm_test_case test_cursor_marker_detection
fm_test_case test_secondmate_model_effort_tokens
fm_test_case test_pi_signed_detection_and_session_lock_identity
fm_test_case test_dash_leading_process_names_are_basename_operands
fm_test_case test_propagate_lib
fm_test_case test_spawn_split_and_inherit
fm_test_case test_spawn_backward_compat_crew_fallback
fm_test_case test_spawn_bare_backward_compat
fm_test_case test_spawn_explicit_harness_wins
fm_test_case test_spawn_unverified_secondmate_harness_refused
fm_test_case test_spawn_cursor_secondmate_launches_with_its_primary_contract
fm_test_case test_spawn_backend_precedence_over_inherited_config
fm_test_case test_spawn_explicit_backend_precedence_over_env_and_inherited_config
fm_test_case test_spawn_bare_harness_no_model_effort_flag
fm_test_case test_spawn_secondmate_harness_model_token
fm_test_case test_spawn_secondmate_harness_model_and_effort_tokens
fm_test_case test_spawn_explicit_model_overrides_secondmate_harness_token
fm_test_case test_spawn_explicit_effort_overrides_secondmate_harness_token
fm_test_case test_spawn_explicit_harness_does_not_inherit_secondmate_harness_tokens
fm_test_case test_spawn_explicit_harness_uses_explicit_profile_axes
fm_test_case test_spawned_secondmate_uses_its_harness_supervision_model
fm_test_case test_spawn_fallback_chain_and_crew_scout_unaffected
fm_test_case test_bootstrap_sweep_propagates_and_reconverges
fm_test_case test_bootstrap_sweep_propagates_when_tracked_current
fm_test_case test_bootstrap_sweep_defers_dispatch_on_stale_unignored_home
fm_test_case test_bootstrap_sweep_materializes_and_inherits_memory_default
fm_test_case test_backend_inheritance_present_and_absent
fm_test_case test_presentation_inheritance_default_on_and_opt_out
fm_test_case test_bootstrap_sweep_surfaces_config_propagation_failure
fm_test_case test_bootstrap_rereads_after_partial_propagation
fm_test_case test_config_push_propagates_reports_without_ff_or_nudge
fm_test_case test_config_push_reports_skips_dirty_and_invalid_home
fm_test_case test_config_push_exits_nonzero_on_copy_error
fm_test_case test_config_push_rereads_after_partial_propagation
fm_test_case test_config_reread_per_home_changed_sets_and_exact_bytes
fm_test_case test_config_reread_isolation_and_absent_and_send_failure
fm_test_case test_config_reread_publication_failure_retries_exact_generation
fm_test_case test_config_reread_write_failure_retains_exact_retry_generation
fm_test_case test_config_reread_exact_temp_survives_adoption_failure
fm_test_case test_config_reread_serializes_concurrent_pushes
fm_test_case test_config_reread_full_retry_queue_drains_before_new_push
fm_test_case test_config_reread_cleanup_runs_after_mixed_delivery_failure
fm_test_case test_config_reread_stops_after_failed_generation
fm_test_case test_config_reread_skips_when_unchanged_and_reads_after_push
fm_test_case test_config_reread_bootstrap_path_and_spawn_flexibility
fm_test_case test_bootstrap_respawns_before_config_reread
fm_test_case test_spawn_quarantines_pending_rereads_on_cleanup_failure
fm_test_case test_bootstrap_detect_only_does_not_create_state
