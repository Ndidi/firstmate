...
test_disabled_relaunch_clears_prior_trace_context() {
  ...
  fm_launch_unwrap < "$dir/fake/literal" | grep -q '^unset TRACEPARENT; .*claude' \
...
test_harness_switch_moves_the_record_and_clears_prior_wiring() {
  ...
  # Wiring the previous claude incarnation left in state/ (claude's hooks live
  # outside the worktree; bin/fm-spawn.sh owns why).
